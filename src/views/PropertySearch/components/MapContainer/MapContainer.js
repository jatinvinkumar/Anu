...
export class MapContainer extends Component {
  render() {
    return (
    <Map style={{width:this.props.width, height:this.props.height}} styles={style} google={this.props.google} zoom={17} center={37.766792, -122.412129}>
        <HeatMap 
            positions={data}
            opacity={1}
            radius={20}
...
const data = [
    {lat: 37.773785, lng: -122.419180},
    {lat: 37.774142, lng: -122.420433},
    {lat: 37.776110, lng: -122.419942},
    {lat: 37.778486, lng: -122.420150},
    {lat: 37.776007, lng: -122.423055},
    {lat: 37.774006, lng: -122.417787},
    {lat: 37.775041, lng: -122.420126},
    {lat: 37.775329, lng: -122.419622},
    {lat: 37.772827, lng: -122.420019},
    {lat: 37.773777, lng: -122.42233},
    {lat: 37.775326, lng: -122.421846},
    {lat: 37.775364, lng: -122.420124},
    {lat: 37.775355, lng: -122.420143},
    {lat: 37.775359, lng: -122.420124},
    {lat: 37.775352, lng: -122.420116},
    {lat: 37.775697, lng: -122.418099},
    {lat: 37.775636, lng: -122.41821},
    {lat: 37.775618, lng: -122.41830},
    {lat: 37.775223, lng: -122.425736},
    {lat: 37.766792, lng: -122.41212},
