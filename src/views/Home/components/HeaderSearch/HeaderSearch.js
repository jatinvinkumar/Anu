        ...
        return(
            ...
            <Grid style={{}} item>
                <div style={{position:'relative', overflow:'hidden', height:900}} >
                    <img style={{ objectFit:'cover', width:'100%', height:900}} src={testPhoto} />
                    <div style={{zIndex: 100, position:'absolute', width:'100%', bottom:0, height:'100%', alignSelf:'center', color: 'white', borderRadius: 8}}>
